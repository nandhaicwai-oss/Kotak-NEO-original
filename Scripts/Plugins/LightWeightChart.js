...
! function () {
    ...
    class O {
        ...
        nt(t, i, s, n) {
            if (!this.qt.Et || !this.qt.ri || this.qt.ri.length === 0) return;
            const e = this.qt.R,
                r = this.ei.Z,
            ...
            t.useMediaCoordinateSpace((({
                ...
                const s = h.Si;
                t.font = i.k, t.textAlign = h.li ? "right" : "left", t.textBaseline = "middle", t.fillStyle = e, t.fillText(this.qt.ri, s.Ci, (s._i + s.xi) / 2 + s.Pi)
            }))
        }
        hi(t, i, s, n) {
            const {
            ...
            } = t, o = this.qt.pi || !this.qt.yi ? i.C : 0, _ = this.qt.ki ? i.S : 0, u = i.A + this.ei.Ti, c = i.V + this.ei.Ri, d = i.B, f = i.I, p = this.qt.ri, v = i.P, m = s.Di(e, p), w = Math.ceil(s.Ei(e, p)), g = v + u + c, M = i.S + d + f + w + o, b = Math.max(1, Math.floor(l));
    ...
    class j extends U {
        constructor(t, i) {
            super(), this.Pt = null, this.ds = NaN, this.fs = 0, this.ps = !1, this.vs = new Map, this.ws = !1, this.gs = new WeakMap, this.Ms = new WeakMap, this.bs = NaN, this.xs = NaN, this.Ss = NaN, this.Cs = NaN, this.ts = t, this.Ps = i;
            this.ys = ((t, i) => s => {
                const n = i(),
                    e = t();
                if (s === a(this.Pt).ks()) return {
                    gt: e,
                    Bi: n
                };
                {
    ...
    class G extends K {
        constructor(t, i) {
            if (super(), i || (i = 1), u(t) && c(t) || (t = 100), t < 0) throw new TypeError("invalid base");
    ...
    class Mt {
        constructor(t) {
            this.yr = (t, i) => void 0 !== i ? i.Ft : this.ge.Xs().kr(t), this.ge = t, this.Tr = gt[t.Rr()]
        }
        Dr(t, i) {
    ...
    class Ut extends wt {
        constructor(t, i, s, n, e) {
            super(t), this.qt = new yt, this.er = new _t(this), this.bh = [], this.xh = new ht(this), this.Sh = null, this.Ch = null, this.Ph = null, this.yh = [], this.Ps = s, this.kh = i;
            const r = new ut(this);
            this.vs = [r], this.rr = new nt(r, this, t), Ht.includes(this.kh) && (this.Sh = new ot(this)), this.Th(), this.sh = n(this, this.Qt(), e)
        }
        m() {
        ...
        Xh(t) {
            ...
            Lt(this.yh, Nt, "top", i);
            const s = this.Sh;
            return null !== s && s.Et() ? (null === this.Ph && s.Se() && (this.Ph = setTimeout((() => {
    ...
    class qt {
        ...
        Ma(t, i, s) {
            ...
            if (null === r) return n;
            const h = e.Nt(t, r),
                a = s.ba().filter((t => t instanceof Ut)).reduce(((t, n) => {
    ...
    class oi {
        ...
        Oa(t, i, s) {
            ...
            if (e <= n + 1e-14 && (e = n), e = Math.max(1, e), this.za.length > 0 && (a = e, l = 1, o = 1e-14, Math.abs(a - l) < o))
                for (r = 0, h = this.za[0]; Kt(e, s * h, 1e-14) && e > n + 1e-14;) e /= h, h = this.za[++r % this.za.length];
            var a, l, o;
            return e
        }
    }
    class _i {
        ...
        $a(t, i, s, n, e, r) {
            ...
            for (let c = s - l; c > n; c -= i) {
                ...
                null !== _ && Math.abs(s - _) < this.Fa() || (s < e || s > r || (u < h.length ? (h[u].ya = s, h[u].Ga = a.Ja(c), h[u].Xa = c) : h.push({
                    ya: s,
                    Ga: a.Ja(c),
                    Xa: c
                }), u++, _ = s, a.Qa() && (i = this.Oa(c * o, n))))
            }
            h.length = u
        }
        Ka(t, i, s, n, e, r) {
    ...
    class pi {
        ...
        ql(t, i, s) {
            ...
            for (let s = u; s < c; s++) {
                ...
                let c = n + _ * (h - r),
                    f = o ? c : this.sl - 1 - c;
                e.Yl = f, c = n + _ * (a - r), f = o ? c : this.sl - 1 - c, e.Kl = f, c = n + _ * (l - r), f = o ? c : this.sl - 1 - c, e.Xl = f, c = n + _ * (u - r), f = o ? c : this.sl - 1 - c, e.Zl = f
            }
        }
        Ts(t, i) {
            const s = this.Pl(t, i);
        ...
        ro(t) {
            ...
            let i = (this.ml + .2 * (this.sl - 1)) / (t + .2 * (this.sl - 1));
        ...
        po() {
            ...
            if (this.ja() && (n = Math.max(n, this.Ya()), e = Math.max(e, this.Ya())), n === this.ol && e === this._l || (this.ol = n, this._l = e, this.vl = null, this.Tl()), null !== i) {
                if (i.$e() === i.je()) {
                    ...
                    this.Qa() && (i = ai(i, this.gl)), i = new dt(i.$e() - s, i.je() + s), this.Qa() && (i = hi(i, this.gl))
                }
                if (this.Qa()) {
    ...
    class mi {
        ...
        m() {
            this.Qt().Eo().u(this), this.Po.Al().u(this), this.ko.Al().u(this), this.dl.forEach((t => {
                t.m && t.m()
        ...
        zl(t) {
            this.sl = t, this.Po.zl(t), this.ko.zl(t), this.dl.forEach((i => {
                if (this.Un(i)) {
                    const s = i.Wt();
                    null !== s && s.zl(t)
                }
        ...
        io(t, i) {
            ...
            r(-1 !== s, "removeDataSource: invalid data source"), this.dl.splice(s, 1), i || this.dl.forEach(((t, i) => t.ls(i)));
            const n = a(t.Wt()).wa();
            if (this.wo.has(n)) {
                const i = h(this.wo.get(n)),
                    s = i.indexOf(t); - 1 !== s && (i.splice(s, 1), 0 === i.length && this.wo.delete(n))
            }
            const e = t.Wt();
        ...
        Jo() {
            this.Wo(this.Po), this.Wo(this.ko), this.dl.forEach((t => {
        ...
        Qo(t, i) {
            ...
            const s = this.dl.indexOf(t);
            r(-1 !== s, "setSeriesOrder: invalid data source"), this.dl.splice(s, 1), this.dl.splice(i, 0, t), this.dl.forEach(((t, i) => t.ls(i))), this.pl = null;
    ...
    class Pi {
        ...
        w_(t, i) {
            ...
            for (let s = i; s < t.length; ++s) {
                ...
                void 0 === n && (n = [], this.p_.set(i.timeWeight, n)), n.push({
                    index: s,
                    time: i.time,
                    weight: i.timeWeight,
        ...
        g_(t) {
            ...
            const i = [];
            this.p_.forEach(((s, n) => {
                t <= s[0].index ? i.push(n) : s.splice(xt(s, t, (i => i.index < t)), 1 / 0)
            }));
    ...
    class Ti {
        ...
        Ea() {
            ...
            for (const t of h) {
                ...
                let s;
                d < this.H_.length ? (s = this.H_[d], s.coord = this.jt(t.index), s.label = this.Mu(t), s.weight = t.weight) : (s = {
                    needAlignCoordinate: !1,
                    coord: this.jt(t.index),
                    label: this.Mu(t),
                    weight: t.weight
                }, this.H_.push(s)), this.j_ > i / 2 && !_ ? s.needAlignCoordinate = !1 : s.needAlignCoordinate = u && t.index <= l || c && t.index >= o, d++
            }
        ...
        Y_() {
            ...
            const t = this.ts.Ys();
            for (const i of t)
                for (const t of i.ma()) this.W_.set(t, !0);
            this.F_++
        }
        gu() {
        ...
        Mu(t) {
            ...
            return void 0 === i && (i = new xi((t => this.Uu(t)), this.o_), this.V_.set(t.weight, i)), i.__(t)
        }
        Uu(t) {
    ...
    class Ii {
        ...
        hr(t) {
            _(this.Ps, t), this.$u.forEach((i => i.Ro(t))), void 0 !== t.timeScale && this.uh.hr(t.timeScale), void 0 !== t.localization && this.uh.K_(t.localization), (t.leftPriceScale || t.rightPriceScale) && this.Yu.p(), this.tc = this.sc(0), this.nc = this.sc(1), this.Bh()
        }
        lc(t, i, s = 0) {
            const n = this.$u[s];
            if (void 0 === n) return;
        ...
        m() {
            this.$u.forEach((t => t.m())), this.$u.length = 0, this.Ps.localization.priceFormatter = void 0, this.Ps.localization.percentageFormatter = void 0, this.Ps.localization.timeFormatter = void 0
        }
        Ec() {
            return this.Gu
        }
    ...
    function Li(t, i, s) {
        return i.replace(/yyyy/g, (t => Z(Oi(t), 4))(t)).replace(/yy/g, (t => Z(Oi(t) % 100, 2))(t)).replace(/MMMM/g, ((t, i) => new Date(t.getUTCFullYear(), t.getUTCMonth(), 1).toLocaleString(i, {
            month: "long"
        }))(t, s)).replace(/MMM/g, ((t, i) => new Date(t.getUTCFullYear(), t.getUTCMonth(), 1).toLocaleString(i, {
            month: "short"
        }))(t, s)).replace(/MM/g, (t => Z((t => t.getUTCMonth() + 1)(t), 2))(t)).replace(/dd/g, (t => Z((t => t.getUTCDate())(t), 2))(t))
    }
    class Ni {
    ...
    function Yi(t, i) {
        ...
        for (let s = ji.length - 1; s >= 0; --s)
            if (Math.floor(i.getTime() / ji[s].sd) !== Math.floor(t.getTime() / ji[s].sd)) return ji[s].nd;
        return 0
    }
    ...
    class Ji {
        ...
        formatTickmark(t, i) {
            ...
            return function (t, i, s) {
                ...
                const e = void 0 === t.rd ? new Date(1e3 * t.ed) : new Date(Date.UTC(t.rd.year, t.rd.month - 1, t.rd.day));
        ...
        fillWeightsForPoints(t, i) {
            ! function (t, i = 0) {
                ...
                for (let r = i; r < t.length; ++r) {
                    ...
                    null !== n && (i.timeWeight = Yi(h, n)), e += i.time.ed - (s || i.time.ed), s = i.time.ed, n = h
                }
                if (0 === i && t.length > 1) {
    ...
    function _s(t) {
        hs && void 0 !== window.chrome && t.addEventListener("mousedown", (t => {
    ...
    class us {
        constructor(t, i, s) {
            this.ld = 0, this.od = null, this._d = {
                ...
                _t: Number.NEGATIVE_INFINITY,
                ut: Number.POSITIVE_INFINITY
            }, this.pd = null, this.vd = !1, this.md = null, this.wd = null, this.gd = !1, this.Md = !1, this.bd = !1, this.xd = null, this.Sd = null, this.Cd = null, this.Pd = null, this.yd = null, this.kd = null, this.Td = null, this.Rd = 0, this.Dd = !1, this.Ed = !1, this.Vd = !1, this.Bd = 0, this.Id = null, this.Ad = !ls(), this.zd = t => {
                this.Od(t)
            }, this.Ld = t => {
                if (this.Nd(t)) {
                    const i = this.Wd(t);
        ...
        Gd() {
            this.Zd.addEventListener("mouseenter", this.Qd.bind(this)), this.Zd.addEventListener("touchcancel", this.Jd.bind(this));
            {
                const t = this.Zd.ownerDocument,
                    i = t => {
                        this.jd.xf && (t.composed && this.Zd.contains(t.composedPath()[0]) || t.target && this.Zd.contains(t.target) || this.jd.xf())
                    };
                this.Sd = () => {
            ...
            ls() && (this.Cd = () => {
                ...
                passive: !0
            }), _s(this.Zd), this.Zd.addEventListener("mousedown", this.Mf.bind(this)), this.Cf(), this.Zd.addEventListener("touchmove", (() => { }), {
                passive: !1
            })
        }
        Cf() {
            void 0 === this.jd.Pf && void 0 === this.jd.yf && void 0 === this.jd.kf || (this.Zd.addEventListener("touchstart", (t => this.Tf(t.touches)), {
                passive: !0
    ...
    class Rs {
        constructor(t, i, s, n) {
            this.qi = null, this.Op = null, this.Lp = !1, this.Np = new it(200), this.Wp = null, this.Fp = 0, this.Hp = !1, this.Up = () => {
        ...
        sv() {
            ...
            if (null !== r && null !== this.Op && (2 !== (h = this.Ps.crosshair).mode && h.horzLine.visible && h.horzLine.labelVisible)) {
                ...
                t = Math.max(t, this.Np.Ei(s, this.qi.Zi(Math.floor(Math.min(i, n)) + .11111111111111, r)), this.Np.Ei(s, this.qi.Zi(Math.ceil(Math.max(i, n)) - .11111111111111, r)))
            }
            var h;
            s.restore();
            const l = t || 34;
        ...
        rv(t) {
            null !== this.Op && ts(this.Op, t) || (this.Op = t, this.Hp = !0, this.Zp.resizeCanvasElement(t), this.Gp.resizeCanvasElement(t), this.Hp = !1, this.qf.style.width = `${t.width}px`, this.qf.style.height = `${t.height}px`)
        }
        hv() {
        ...
        av(t) {
            ...
            if (1 !== t) {
                ...
                null !== t && (t.useBitmapCoordinateSpace((t => {
                    this.ov(t), this._v(t)
                })), this.Pt.uv(t, this.Xp), this.cv(t), this.Pt.uv(t, this.Yp), this.dv(t))
            }
        ...
        cv(t) {
            ...
            s.borderVisible && s.ticksVisible && t.useBitmapCoordinateSpace((({
                ...
                t.font = this.nv(), t.fillStyle = s.textColor ?? this.bl.textColor, t.textAlign = this.qp ? "right" : "left", t.textBaseline = "middle";
        ...
        lv() {
            ...
            const i = [],
                ...
                n = this.Pt.hp(),
                e = this.iv();
            this.qi === n.$n() && this.Pt.hp().Dt().forEach((t => {
                n.Un(t) && s.push(t)
            }));
        ...
        vv(t, i, s) {
            ...
            for (const s of t) {
                const t = Math.floor(s.$t(i) / 2),
                    n = s.Bi();
                n > -t && n < t && s.Fi(t), n > this.Op.height - t && n < this.Op.height + t && s.Fi(this.Op.height - t)
            }
    ...
    class Is {
        constructor(t, i) {
            this.Op = Qi({
                width: 0,
                height: 0
            }), this.mv = null, this.wv = null, this.gv = null, this.Mv = null, this.bv = !1, this.xv = new o, this.Sv = new o, this.Cv = 0, this.Pv = !1, this.yv = null, this.kv = !1, this.Tv = null, this.Rv = null, this.Hp = !1, this.Up = () => {
        ...
        zv(t) {
            null !== this.Dv && this.Dv.t_().u(this), this.Dv = t, null !== this.Dv && this.Dv.t_().i(Is.prototype.Ev.bind(this), this, !0), this.Av(), this.Dp.Uf().indexOf(this) === this.Dp.Uf().length - 1 ? (this.gv = this.gv ?? new bs(this.Vv, this.Dp), this.gv.yt()) : (this.gv?.Vp(), this.gv = null)
        }
        $p() {
            return this.Dp
        }
        ...
        $v(t) {
            ...
            if (null !== this.Mv || this.hm(t) || (this.Mv = {
                ...
                if (t.Bf && r.touch || !t.Bf && r.mouse) {
                    const t = s.vu();
                    this.Rv = new Ms(.2 / t, 7 / t, .997, 15 / t), this.Rv.Cp(s.wu(), this.Mv.ed)
                } else this.Rv = null;
    ...
    class As {
        constructor(t, i, s, n, e) {
            this.St = !0, this.Op = Qi({
                width: 0,
                height: 0
            }), this.Up = () => this.av(3), this.qp = "left" === t, this.Gu = s.Ec, this.Ps = i, this.um = n, this.dm = e, this.qf = document.createElement("div"), this.qf.style.width = "25px", this.qf.style.height = "100%", this.qf.style.overflow = "hidden", this.Zp = xs(this.qf, Qi({
                width: 16,
                height: 16
            })), this.Zp.subscribeSuggestedBitmapSizeChanged(this.Up)
        }
        ...
        rv(t) {
            ts(this.Op, t) || (this.Op = t, this.Zp.resizeCanvasElement(t), this.qf.style.width = `${t.width}px`, this.qf.style.height = `${t.height}px`, this.St = !0)
        }
        av(t) {
    ...
    class Ws {
        constructor(t, i) {
            this.fm = null, this.pm = null, this.M = null, this.vm = !1, this.Op = Qi({
                width: 0,
                height: 0
            }), this.wm = new o, this.Np = new it(5), this.Hp = !1, this.Up = () => {
        ...
        ym(t, i, s) {
            ts(this.Op, t) || (this.Op = t, this.Hp = !0, this.Zp.resizeCanvasElement(t), this.Gp.resizeCanvasElement(t), this.Hp = !1, this.qf.style.width = `${t.width}px`, this.qf.style.height = `${t.height}px`, this.wm.p(t)), null !== this.fm && this.fm.rv(Qi({
                width: i,
                height: t.height
        ...
        av(t) {
            ...
            if (1 !== t) {
                ...
                })), this.cv(s), this.Dm(s, Os)), null !== this.fm && this.fm.av(t), null !== this.pm && this.pm.av(t)
            }
            this.Gp.applySuggestedBitmapSize();
            const s = rs(this.Gp, i);
            null !== s && (s.useBitmapCoordinateSpace((({
                ...
                t.clearRect(0, 0, i.width, i.height)
            })), this.Em([...this.Dp.Qt().Ys(), this.Dp.Qt()._c()], s), this.Dm(s, Ls))
        }
        Dm(t, i) {
        ...
        cv(t) {
            ...
            r.borderVisible && r.ticksVisible && t.useBitmapCoordinateSpace((({
                ...
                t.textAlign = "center", t.textBaseline = "middle", t.fillStyle = this.H(), t.font = this.nv();
                for (const e of s)
                    if (e.weight < n) {
        ...
        Tm() {
            ...
            if (t.k !== i) {
                const s = this.W();
                t.P = s, t.k = i, t.A = 3 * s / 12, t.V = 3 * s / 12, t.Ji = 9 * s / 12, t.O = 0, t.Rm = 4 * s / 12, t.Gi.Vn()
            }
            return this.M
        }
        pv(t) {
    ...
    const Fs = !!hs && !!navigator.userAgentData && navigator.userAgentData.brands.some((t => t.brand.includes("Chromium"))) && !!hs && (navigator?.userAgentData?.platform ? "Windows" === navigator.userAgentData.platform : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
    class Hs {
        constructor(t, i, s) {
            var n;
        ...
        aw(t) {
            ...
            if (this.Ps.timeScale.visible) {
                ...
                if (null !== t) {
                    let e = 0;
                    this.ow() && (r("left", e, s), e = a(n.sm()).Gf().width), this.Xm.Jf(t, e, s), e += i.width, this._w() && r("right", e, s)
                }
                s += i.height
            }
            return Qi({
        ...
        pw() {
            let t = 0,
                i = 0,
                s = 0;
            for (const n of this.Am) this.ow() && (i = Math.max(i, a(n.sm()).sv(), this.Ps.leftPriceScale.minimumWidth)), this._w() && (s = Math.max(s, a(n.nm()).sv(), this.Ps.rightPriceScale.minimumWidth)), t += n.Vo();
            i = os(i), s = os(s);
            const n = this.Mo,
                e = this.sl,
                r = Math.max(n - i - s, 0),
            ...
            for (let t = 0; t < this.Am.length; ++t) {
                ...
                let e = 0,
                    h = 0;
                h = t === this.Am.length - 1 ? Math.ceil((c - f) * p) / p : Math.round(n.Vo() * d * p) / p, e = Math.max(h, 2), f += e, n.rv(Qi({
                    width: r,
                    height: e
                })), this.ow() && n.Gv(i, "left"), this._w() && n.Gv(s, "right"), n.hp() && this.ts.cc(n.hp(), e)
            }
            this.Xm.ym(Qi({
                width: l ? r : 0,
                height: o
        ...
        nw(t, i) {
            const s = t.nn();
            3 === s && this.ww(), 3 !== s && 2 !== s || (this.gw(t), this.Mw(t, i), this.Xm.yt(), this.Am.forEach((t => {
                t.Lv()
            })), 3 === this.Wm?.nn() && (this.Wm.vn(t), this.ww(), this.gw(this.Wm), this.Mw(this.Wm, i), t = this.Wm, this.Wm = null)), this.av(t)
        }
        Mw(t, i) {
        ...
        Zu(t) {
            null !== this.Wm ? this.Wm.vn(t) : this.Wm = t, this.Fm || (this.Fm = !0, this.Om = window.requestAnimationFrame((t => {
        ...
        Jm() {
            ...
            for (let n = s; n < i; n++) {
                ...
                if (i.Kv().i(this.bw.bind(this, i), this), i.Xv().i(this.xw.bind(this, i), this), this.Am.push(i), n > 0) {
    ...
    class hn {
        ...
        Ww(t, i) {
            ...
            if (void 0 !== e)
                if (1 === this.Ow.size) s = !1, n = !0, this.zw.clear();
                    ...
                    for (const i of this.Nw) i.pointData.Bw.delete(t) && (n = !0);
            let r = [];
            if (0 !== i.length) {
            ...
            if (n) {
                ...
                })), t.sort(((t, i) => this.o_.key(t.time) - this.o_.key(i.time))), h = this.Uw(t)
            }
        ...
        qw(t, i, s) {
            ...
            const e = this.o_.createConverterToInternalObj([i])(i.time),
                r = this.Lw.get(t);
            if (!s && void 0 !== r && this.o_.key(e) < this.o_.key(r)) throw new Error(`Cannot update oldest data, last time=${r}, new time=${e}`);
    ...
    class dn extends un {
        constructor(t, i, s) {
            super(t, i, !1), this.sh = s, this.hg = new cn(this.sh.renderer(), (i => {
                const s = t.zt();
    ...
    class Wn {
        constructor(t, i, s) {
            ...
            this.Og = i, this.Ff = new Hs(t, n, i), this.Ff.Kv().i((t => {
        ...
        panes() {
            return this.Ff.Qt().$s().map((t => this.$g(t)))
        }
        paneSize(t = 0) {
        ...
        Ug(t) {
            const i = this.Ff.Qt();
            i.Dc(t.It.ou, t.It.Gw, t.It.Jw), t.Lo.forEach(((t, i) => i.ht(t.se, t.Zw))), i.It().Y_(), i.pu()
        }
        jg(t) {
    ...
    class le extends P {
        ...
        et(t) {
            ...
            const {
                ...
                Xt: h,
                Xg: a
            } = this.rt, l = this.rt.eM ?? (this.rt.rM ? 0 : t.mediaSize.height);
            if (null === s) return;
            const o = t.context;
    ...
    class ce extends Un {
        constructor(t, i) {
            super(t, i), this.hg = new C, this.wM = new _e, this.gM = new ue, this.hg.st([this.wM, this.gM])
        }
        Yg(t, i, s) {
            return {
                ...this.qg(t, i),
    ...
    class pe extends Un {
        constructor(t, i) {
            super(t, i), this.hg = new C, this.MM = new fe, this.bM = new Gn, this.hg.st([this.MM, this.bM])
        }
        Yg(t, i, s) {
            return {
                ...this.qg(t, i),
    ...
    class we extends un {
        ...
        og() {
            const t = this.Jn.Rh();
            this.sg = this.Jn.Xs().Hr().map((i => this.Yg(i.Re, i, t)))
        }
    }
    class ge extends we {
        constructor() {
    ...
    class be extends P {
        ...
        _v(t, i, s) {
            ...
            for (let t = s.from; t < s.to; t++) {
                ...
                let o = Math.round(s._t * e) - Math.floor(.5 * this.xM);
                const _ = o + this.xM - 1,
                    u = Math.round(Math.min(s.Yl, s.Zl) * r),
                    c = Math.round(Math.max(s.Yl, s.Zl) * r);
                if (null !== l && (o = Math.max(l + 1, o), o = Math.min(o, _)), this.qt.vu * e > 2 * a) V(n, o, u, _ - o + 1, c - u + 1, a);
                else {
                    const t = _ - o + 1;
        ...
        EM(t, i, s) {
            ...
            for (let t = s.from; t < s.to; t++) {
                ...
                let l = Math.round(Math.min(s.Yl, s.Zl) * r),
                    ...
                    _ = Math.round(s._t * e) - Math.floor(.5 * this.xM),
                    u = _ + this.xM - 1;
                if (s.cr !== h) {
                    const t = s.cr;
                    n.fillStyle = t, h = t
    ...
    class Ce extends P {
        ...
        BM(t) {
            ...
            for (let t = this.qt.lt.from + 1; t < this.qt.lt.to; t++) {
                ...
                s.wt === n.wt + 1 && (s.Uh - n.bi !== i + 1 && (n.AM > n.ne ? n.bi = s.Uh - i - 1 : s.Uh = n.bi + i + 1))
            }
        ...
        draw(t) {
            t.useMediaCoordinateSpace((t => {
                ...
                for (const t of this.qt.lines) {
                    ...
                    i.translate(n, e), i.textBaseline = "top", i.font = t.k, i.scale(t.Su, t.Su), i.fillText(t.text, 0, t.WM), i.restore(), e += t.lineHeight * t.Su
                }
            }))
        }
        NM(t, i) {
    ...
    class Le {
        ...
        draw(t) {
            t.useMediaCoordinateSpace((t => {
                ...
                s && this.qt.jM && (i.globalAlpha = this.qt.alpha ?? 1, i.drawImage(this.qt.jM, s._t, s.ut, s.Qi, s.$t))
            }))
        }
        $M(t, i) {
            const {
    ...
    class He {
        ...
        attached(t) {
            ...
            this.eb = i, this.sb = new Image, this.sb.onload = () => {
                const t = this.sb?.naturalHeight ?? 1,
                    i = this.sb?.naturalWidth ?? 1;
                this.HM.forEach((s => s.GM({
                    QM: t,
                    JM: i,
                    tb: this.sb
                }))), this.eb && this.eb()
    ...
    class Je {
        ...
        draw(t) {
            "aboveSeries" !== this.ab && t.useBitmapCoordinateSpace((t => {
                this.et(t)
            }))
        }
        drawBackground(t) {
        ...
        et({
            ...
            if (null !== this.qt && null !== this.qt.lt) {
                ...
                for (let n = this.qt.lt.from; n < this.qt.lt.to; n++) {
                    ...
                    void 0 !== e.ri && (e.ri.Qi = this.Ln.Ei(t, e.ri.lb), e.ri.$t = this.W, e.ri._t = e._t - e.ri.Qi / 2), Qe(e, t, i, s)
                }
            }
        }
    }
    ...
    function sr(t, i, s, n, e, r, h, l) {
        ...
        switch (i.position) {
            ...
            case "atPriceTop": {
                const i = _ ? 0 : n._b;
                return t.ut = a(h.priceToCoordinate(o)) - p - i, void 0 !== t.ri && (t.ri.ut = t.ut - p - .6 * e, n._b += 1.2 * e), void (_ || (n._b += f + r))
            }
            case "belowBar":
            case "atPriceBottom": {
                const i = _ ? 0 : n.ub;
                return t.ut = a(h.priceToCoordinate(o)) + p + i, void 0 !== t.ri && (t.ri.ut = t.ut + p + r + .6 * e, n.ub += 1.2 * e), void (_ || (n.ub += f + r))
            }
        }
    }
    class nr {
    ...
    class rr {
        ...
        attached(t) {
            this.kb(), this.Dp = t.chart, this.ge = t.series, this.sh = new nr(this.ge, a(this.Dp), this.Ps), this.eb = t.requestUpdate, this.ge.subscribeDataChanged((t => this.Pg(t))), this.yb = !0, this.UM()
        }
        UM() {
            this.eb && this.eb()
        }
        ...
        Eb() {
            return null === this.Cb && (this.Cb = this.cb.reduce(((t, i) => (t[i.position] || (t[i.position] = !0), t)), {
                inBar: !1,
                aboveBar: !1,
                belowBar: !1,
                atPriceTop: !1,
    ...
    class ar {
        ...
        Nb() {
            const t = Date.now(),
                i = [];
            for (const [s, n] of this.cb) !n.Ob || n.Ob > t ? i.push({
                time: n.time,
                sign: n.sign,
                value: n.value
            }) : this.Ib(s);
    ...
    class cr {
        constructor(t) {
            this.Dp = void 0, this.ge = void 0, this.HM = [], this.o_ = null, this.qb = new Map, this.Yb = new ar((() => this.UM())), this.Ps = {
                ...lr,
                ...t
            }
        }
